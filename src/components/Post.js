  ...
  return (
    <div className="Post">
      <div className="Post-header">
        <img src={post.thumbnail} alt="Автор" className="Post-avatar" /> {/* Отображаем изображение автора поста */}
      ...
      <div className="Post-content">
        ...
        <p className="Post-description">{post.description}</p> {/* Отображаем описание поста */}
        <a href={post.link} target="_blank" rel="noreferrer" className="Post-link">Читать далее</a> {/* Отображаем ссылку на полный текст поста */}
      </div>
      <div className="Post-footer">
        <div className="Post-date">{post.pubDate}</div> {/* Отображаем дату публикации поста */}
